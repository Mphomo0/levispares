      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-accent/50"
          >
        ...
        {statsCards.map((stat) => (
          ...
          >
            ...
            <CardContent>
              ...
              <p
                className={`text-xs ${stat.positive ? 'text-green-600' : 'text-red-600'}`}
              >
            ...
            {topProducts.map((product, index) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p
                    className={`text-xs ${product.growth.startsWith('+') ? 'text-green-600' : 'text-red-600'}`}
                  >
                    {product.growth}
                  </p>
                </div>
