    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 font-sans antialiased">
      ...
      <div className="lg:pl-64">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200 dark:border-slate-700 bg-white/95 dark:bg-slate-800/95 backdrop-blur px-4 lg:px-6">
          ...
          <button className="md:hidden p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
          </button>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <button className="flex items-center gap-2 p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 safe-area-pb">
